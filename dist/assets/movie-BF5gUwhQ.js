...
`;var h=document.querySelector(`.video-frag`);if(f){let e=document.createElement(`a`);e.href=f.url,e.target=`_blank`,e.classList.add(`trailer-button`),e.innerHTML=`Смотреть трейлер`,h.appendChild(e)}else h.parentElement.style.display=`none`;var g=document.querySelector(`.card-slider`),_=d.cadrs.items;if(_&&_.length>0)_.forEach(e=>{g.appendChild(t(e.imageUrl)),console.log(e.imageUrl)});else{let e=document.querySelector(`.fragments-contanier`);e&&(e.style.display=`none`)}console.log(_);var v=e=>{let t=``;for(let n=0;n<e;n++)if(t+=`<img src="../assets/star-black.svg" alt="star" class="review-item-rating-item">`,n===10)return t;for(let n=e;n<10;n++)t+=`<img src="../assets/star.svg" alt="star" class="review-item-rating-item">`;return t},y=document.querySelector(`.review-list`),b=d.reviews.items;if(b&&b.length>0)e(b,2).forEach(e=>{y.innerHTML+=`
